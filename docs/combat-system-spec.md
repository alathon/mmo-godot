...
| Field | Type | Description |
|---|---|---|
| `formula` | `float` | Base damage before stat modifiers (stats TBD). |
...
```
aggro_generated = formula * aggro_modifier * hit_type_modifier
```

Where `hit_type_modifier` is:
- Hit: `1.0`
- Critical: `1.0` (crits do more damage, so more aggro via formula)
- Miss: `0.25`
- Dodge: `0.25`
- Block: `0.75`
