class_name DamageTakenGameEventData
extends RefCounted
...
static func create(
		...
		p_ability_id: int,
		p_amount: float) -> DamageTakenGameEventData:
	var data := DamageTakenGameEventData.new()
...
static func from_entity_event(event: EntityEvents) -> DamageTakenGameEventData:
